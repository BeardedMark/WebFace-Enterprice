...
<div class="flex-row-13 ai-center product-card" data-offer="{{ $item['offer']['guid'] }}" data-variant="{{ $item['variant']['guid'] ?? '' }}" data-price="{{ $item['variant'] ? $item['variant']['price'] : $item['offer']['maxPrice'] }}" data-quantity="{{ $item['quantity'] ?? 1 }}">
    ...
    <div class="flex-col flex-grow pad-x-5">
        <a class="link flex-col" href="{{ route('offers.show', $item['offer']['guid']) }}">
            ...
            @endisset
                            ...
                            @component('db.offers.data.counter', [
