        ...
        <form class="row g-4 jc-center" action="{{ route('orders.store') }}" method="POST" id="order-form">
            ...
            <div class="col-12 col-md-7 order-2 order-md-1">
                <div class="flex-col-34">
                    <x-header tag='h1' size='xxl' color='brand' title="Оформление заказа" description="Заполните данные для оформления заказа" />
                    ...
                    <div class="flex-col-13">
                        ...
                        <div id="delivery-fields" class="flex-col-13">
                            <div class="flex-col">
                                <label class="pad-x-5" for="address">Адрес доставки
                                    <span class="color-danger">*</span></label>
                                <input class="input" type="text" name="address" id="address"
                                    value="{{ old('address') }}" placeholder="Город, Улица, Номер дома"
                    ...
                    <div class="flex-row-5 jc-end">
                        ...
                        <a class="button-other" href="{{ route('orders.basket') }}">Вернуться в корзину</a>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (activeItems.length === 0) {
                ...
                window.location.href = '{{ route("orders.basket") }}';
                return;
            }
